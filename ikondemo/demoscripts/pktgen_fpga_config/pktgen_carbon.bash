...
do
  date=$(date +%s)
  ethtool -S ens1 > ethstats
  rx_packets=$(grep rx_packets:  ethstats | awk -e '{print $2}')
  rx_bytes=$(grep rx_bytes: ethstats | awk -e '{print $2}')
  rx_packets_phy=$(grep rx_packets_phy ethstats | awk -e '{print $2}')
  rx_bytes_phy=$(grep rx_bytes_phy ethstats | awk -e '{print $2}')
